...
4.Usage Open a web browser and navigate to http://localhost:8080. Use the provided features for user registration, gate pass issuance, and reporting.

5.Technologies Used HTML, CSS, JavaScript, EJS (Embedded JavaScript), Node.js, Express.js, MongoDB.
